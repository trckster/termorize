...
const en = {
    ...
    collectionShareDialogDescription:
        'Anyone with this link can preview this published collection and use it after signing in.',
...
const ru: typeof en = {
    ...
    collectionShareDialogDescription:
        'Любой, у кого есть эта ссылка, может посмотреть опубликованную коллекцию и использовать её после входа.',
