...
const admin = {
    ...
    descriptionsIntro:
        'Descriptions shared across exercises and daily idioms. Regenerate a description and approve the preview to replace it.',
    descriptionsSearch: 'Search words or descriptions…',
    descriptionsEmpty: 'No descriptions found.',
    descriptionsLoadError: 'Could not load descriptions. Please retry.',
    descriptionsModel: 'Regeneration model',
    descriptionsBasic: 'Basic (default)',
    descriptionsMedium: 'Medium',
    descriptionsSmart: 'Smart',
    descriptionsRegenerate: 'Regenerate',
    descriptionsPreviewTitle: 'Review description',
    descriptionsCurrent: 'Current description',
    ...
    wordAudiosTotal: 'Total audios',
    wordAudiosSearchLabel: 'Search word audios',
    wordAudiosSearchPlaceholder: 'Search by word or text...',
    wordAudiosLoadError: 'Unable to load word audios. Please try again.',
    wordAudiosEmpty: 'No generated audios',
    wordAudiosEmptyDescription: 'Audio files will appear after pronunciations are generated.',
    wordAudiosNoResults: 'No matching audios',
    wordAudiosNoResultsDescription: 'Try a different word or phrase.',
    wordAudiosLanguage: 'Language',
    wordAudiosWord: 'Word or text',
    wordAudiosAudio: 'Audio',
    wordAudiosGenerator: 'Generator',
    wordAudiosModel: 'Model',
    wordAudiosVoice: 'Voice',
    wordAudiosGenerated: 'Generated',
    wordAudiosSize: 'File size',
    wordAudiosDetails: 'File details',
    wordAudiosActions: 'Actions',
    wordAudiosTelegramCached: 'Cached in Telegram',
    wordAudiosTelegramNotCached: 'Not cached in Telegram',
    wordAudiosListen: 'Listen to {word}',
    wordAudiosPause: 'Pause {word}',
    wordAudiosAudioLoading: 'Loading audio for {word}',
    wordAudiosAudioError: 'Unable to play audio for {word}',
    wordAudiosRegenerate: 'Regenerate',
    wordAudiosRegenerating: 'Regenerating...',
    wordAudiosRegenerateLabel: 'Remove and regenerate audio for {word}',
...
const en = {
    ...
    dailyIdiomLanguage: 'Idiom language',
    dailyIdiomShow: 'Show idiom',
    dailyIdiomLoading: 'Loading today’s idiom…',
    dailyIdiomError: 'Could not load the idiom and its meaning. Please retry.',
    dailyIdiomEmpty: 'No idioms are available in this language yet.',
    cancel: 'Cancel',
    close: 'Close',
    delete: 'Delete',
    deleting: 'Deleting...',
    ...
    exercisesShowTranslations: 'Show translations',
    exercisesHideTranslations: 'Hide translations',
    ...
    exerciseTypeCharactersDirect: 'Build translation',
    exerciseTypeCharactersReversed: 'Build original',
    exerciseTypeAudioDirect: 'Audio',
    exerciseTypeAudioReversed: 'Reversed audio',
    exerciseTypeDescriptionDirect: 'Description',
    exerciseTypeDescriptionReversed: 'Reversed description',
    exerciseTypeMatchPairs: 'Match pairs',
    exerciseResultCorrect: 'Correct',
    exerciseResultAlmost: 'Almost',
    exerciseResultWrong: 'Wrong',
    exerciseResultIgnored: 'Ignored',
    exerciseNoProgressChange: 'No progress change',
    exercisesDeletedVocabulary: 'Word deleted',
    exerciseReasonTypedAnswer: 'typed answer',
    exerciseReasonChoiceAnswer: 'choice answer',
    exerciseReasonCharacterAnswer: 'character answer',
    exerciseReasonMatchPairs: 'match pairs',
    exerciseReasonSkipped: 'skipped',
    exerciseReasonExpired: 'expired',
    exerciseReasonDeletedVocabulary: 'deleted vocabulary',
    exerciseReasonInvalidOptions: 'invalid options',

    statisticsLabel: 'Statistics',
    statisticsHeading: 'Practice progress',
    statisticsDescription: 'See what you completed, missed, and added to your vocabulary.',
    ...
    exerciseStatIgnoredDesc: 'Exercises skipped, expired, or made unavailable.',
    statisticsLearningTitle: 'Vocabulary progress',
    statisticsLearningWords: 'Words',
    statisticsLearningShare: 'of vocabulary',
    statisticsLearningRange: 'Learning',
    statisticsLearningPrevious: 'Previous learning range',
    statisticsLearningNext: 'Next learning range',
    statisticsLearningKeyboard: 'Use arrow keys to explore learning ranges. Press Escape to dismiss details.',
    statisticsLearningNotStarted: 'Not started',
    statisticsLearningBeginning: 'Getting started',
    statisticsLearningDeveloping: 'Building confidence',
    statisticsLearningConfident: 'Almost there',
    statisticsLearningMastered: 'Fully learned',
    statisticsLearningEmpty: 'Your next chapter starts with a word.',
    statisticsLearningEmptyDescription: 'Add words to your vocabulary to see your learning progress here.',
    statisticsLearningUnavailable: 'Learning progress is currently unavailable.',
    statisticsWeeklyTitle: 'Exercise activity',
    statisticsWeeklyDescription: 'Completed and failed exercises from the previous seven days through today.',
    statisticsCompleted: 'Solved',
    statisticsFailed: 'Failed',
    statisticsTasks: 'tasks',
    statisticsVocabularyTitle: 'Vocabulary activity',
    statisticsVocabularyDescription: 'Words added during this month and the five previous calendar months.',
    statisticsVocabularyDescriptionMobile: 'Words added during the two most recent calendar months.',
    statisticsVocabularyAdded: 'vocabulary items added',
    statisticsLess: 'Less',
    statisticsMore: 'More',
    ...
    translationShortcutEditBeforeSave: 'Edit before saving',
    ...
    translationEditDialogTitle: 'Review before saving',
    ...
    quizShortcutBuild: 'Build answer',
    quizShortcutKeyboard: 'Keyboard',
    ...
    quizTypeMatchPairsHint: 'Match each word with its pair',
    quizTypeAudioHint: 'Listen and translate',
    quizAudioListen: 'Play audio',
    ...
    quizUndoAudioLanguageCountdown: '{seconds}s',
    quizIgnoreAudioError: 'Unable to ignore this audio language. You can continue answering.',
    quizIgnoreDescriptionLanguage: "Don't send me descriptions in {language}",
    quizUndoDescriptionLanguage: 'Undo: allow descriptions in {language}',
    quizIgnoreDescriptionError: 'Unable to ignore this description language. You can continue answering.',
    quizUndoDescriptionError: 'Unable to restore this description language. Please try again.',
    quizUndoAudioError: 'The language is still ignored. Retry undo or continue to the next question.',
    quizRetryUndo: 'Retry undo',
    quizNextQuestion: 'Next question',
    quizCharactersHint: 'Choose the characters in order, or type them on your keyboard',
    quizCharactersLanguageWarning: "This character doesn't match the answer language.",
    quizCharactersAnswerLabel: 'Your answer',
    quizCharactersAvailableLabel: 'Available characters',
    quizCharacterSlot: 'Answer character',
    quizResultCorrect: 'Correct!',
    quizResultAlmost: 'Almost!',
    quizResultWrong: 'Wrong',
    quizCorrectAnswer: 'Correct answer:',
    quizDescriptionTranslation: 'Description translation:',
    quizDescriptionOriginal: 'Original description:',
    ...
    collectionPracticeStart: 'Practice',
    collectionPracticeTitle: 'Collection practice',
    collectionPracticeHistory: 'Collection practice',
    collectionPracticeUnavailable: 'Add at least one word from this collection to your vocabulary to practice.',
    collectionPracticeEmpty: 'No collection words are currently available in your vocabulary.',
    collectionPracticeLoadError: 'Collection practice could not start. Please try again.',
    collectionPracticeKnowledgeUnchanged: 'Knowledge unchanged',
    collectionPracticePointsUnchanged: '±0',
    collectionPracticePointsUnchangedHint: 'Collection practice does not change knowledge points.',
    collectionPracticeMatching: 'Matching review',
    collectionPracticeAgain: 'Practice again',
    collectionPracticeStop: 'Stop practicing',
    ...
    collectionOpenAddTranslationAgain: 'Open this window again',
    ...
    collectionShareUnavailable: 'Publish this collection before sharing it.',
    ...
    collectionLinkCopiedErrorDescription: 'Unable to copy the link. Please try again.',
    ...
    collectionPreviewPublished: 'Published collection',
    collectionPreviewShared: 'Shared collection',
    collectionPreviewLoading: 'Loading collection...',
    collectionPreviewUnavailableTitle: 'Collection unavailable',
    collectionPreviewUnavailableDescription:
        'This collection does not exist, is no longer published, or the sharing link is incorrect.',
    collectionPreviewBack: 'Back to Termorize',
    collectionPreviewJoinTitle: 'Make this collection yours',
    collectionPreviewJoinDescription:
        'Sign in to add this collection to your library, then save any of its words to your vocabulary.',
    collectionPreviewUseTitle: 'Use these words in Termorize',
    collectionPreviewUseDescription:
        'Sign in to save any or all of these word pairs and start practicing them in Termorize.',
    collectionPreviewTryGuest: 'Try without registration',
    collectionPreviewGuestError: 'Could not create a temporary account. Please try again.',
    collectionPreviewWordsTitle: 'Words in this collection',
    collectionPreviewWordsDescription: 'A read-only preview of every published word pair.',
    collectionPreviewFooter: 'Translate. Collect. Remember.',
    collectionPreviewMetaDescription: '{count} word pairs in “{title}”. Preview this published Termorize collection.',
...
const ru: typeof en = {
    ...
    exercisesShowTranslations: 'Показать переводы',
    exercisesHideTranslations: 'Скрыть переводы',
    ...
    exerciseTypeCharactersDirect: 'Собрать перевод',
    exerciseTypeCharactersReversed: 'Собрать оригинал',
    exerciseTypeAudioDirect: 'Аудио',
    exerciseTypeAudioReversed: 'Обратное аудио',
    exerciseTypeDescriptionDirect: 'Описание',
    exerciseTypeDescriptionReversed: 'Обратное описание',
    exerciseTypeMatchPairs: 'Найти пары',
    exerciseResultCorrect: 'Правильно',
    exerciseResultAlmost: 'Почти',
    exerciseResultWrong: 'Ошибка',
    exerciseResultIgnored: 'Пропущено',
    exerciseNoProgressChange: 'Без изменения прогресса',
    exercisesDeletedVocabulary: 'Слово удалено',
    exerciseReasonTypedAnswer: 'текстовый ответ',
    exerciseReasonChoiceAnswer: 'выбор варианта',
    exerciseReasonCharacterAnswer: 'ответ из символов',
    exerciseReasonMatchPairs: 'поиск пар',
    exerciseReasonSkipped: 'пропущено',
    exerciseReasonExpired: 'истекло',
    exerciseReasonDeletedVocabulary: 'слово удалено',
    exerciseReasonInvalidOptions: 'некорректные варианты',

    statisticsLabel: 'Статистика',
    statisticsHeading: 'Прогресс занятий',
    statisticsDescription: 'Здесь видно, что вы выполнили, пропустили и добавили в словарь.',
    ...
    exerciseStatIgnoredDesc: 'Пропущенные, истёкшие или ставшие недоступными упражнения.',
    statisticsLearningTitle: 'Прогресс словаря',
    statisticsLearningWords: 'Слова',
    statisticsLearningShare: 'словаря',
    statisticsLearningRange: 'Изучено',
    statisticsLearningPrevious: 'Предыдущий уровень изучения',
    statisticsLearningNext: 'Следующий уровень изучения',
    statisticsLearningKeyboard:
        'Используйте стрелки для просмотра уровней изучения. Нажмите Escape, чтобы скрыть подробности.',
    statisticsLearningNotStarted: 'Ещё не начато',
    statisticsLearningBeginning: 'Первые шаги',
    statisticsLearningDeveloping: 'Всё увереннее',
    statisticsLearningConfident: 'Почти выучено',
    statisticsLearningMastered: 'Полностью выучено',
    statisticsLearningEmpty: 'Новая глава начинается со слова.',
    statisticsLearningEmptyDescription: 'Добавьте слова в словарь, чтобы увидеть свой прогресс здесь.',
    statisticsLearningUnavailable: 'Прогресс изучения сейчас недоступен.',
    statisticsWeeklyTitle: 'Активность упражнений',
    statisticsWeeklyDescription: 'Выполненные и неудачные упражнения за предыдущие семь дней и сегодня.',
    statisticsCompleted: 'Решено',
    statisticsFailed: 'Ошибки',
    statisticsTasks: 'задания',
    statisticsVocabularyTitle: 'Активность словаря',
    statisticsVocabularyDescription: 'Слова, добавленные в этом и пяти предыдущих календарных месяцах.',
    statisticsVocabularyDescriptionMobile: 'Слова, добавленные за последние два календарных месяца.',
    statisticsVocabularyAdded: 'слов добавлено',
    statisticsLess: 'Меньше',
    statisticsMore: 'Больше',
    ...
    translationShortcutEditBeforeSave: 'Изменить перед сохранением',
    ...
    translationEditDialogTitle: 'Проверьте перед сохранением',
    translationEditDialogDescription:
    ...
    quizShortcutBuild: 'Собрать ответ',
    quizShortcutKeyboard: 'Клавиатура',
    ...
    quizTypeMatchPairsHint: 'Соедините каждое слово с парой',
    quizTypeAudioHint: 'Прослушайте и переведите',
    quizAudioListen: 'Воспроизвести аудио',
    ...
    quizUndoAudioLanguageCountdown: '{seconds} с',
    quizIgnoreDescriptionLanguage: 'Не присылать описания. Язык: {language}',
    quizUndoDescriptionLanguage: 'Отменить: разрешить описания. Язык: {language}',
    quizIgnoreDescriptionError: 'Не удалось исключить язык описаний. Можно продолжить отвечать.',
    quizUndoDescriptionError: 'Не удалось снова разрешить язык описаний. Попробуйте ещё раз.',
    quizIgnoreAudioError: 'Не удалось игнорировать этот язык аудио. Вы можете продолжить отвечать.',
    quizUndoAudioError: 'Язык всё ещё игнорируется. Повторите отмену или перейдите к следующему вопросу.',
    quizRetryUndo: 'Повторить отмену',
    quizNextQuestion: 'Следующий вопрос',
    quizCharactersHint: 'Выбирайте символы по порядку или вводите их с клавиатуры',
    quizCharactersLanguageWarning: 'Этот символ не соответствует языку ответа.',
    quizCharactersAnswerLabel: 'Ваш ответ',
    quizCharactersAvailableLabel: 'Доступные символы',
    quizCharacterSlot: 'Символ ответа',
    quizResultCorrect: 'Правильно!',
    quizResultAlmost: 'Почти!',
    quizResultWrong: 'Неверно',
    quizCorrectAnswer: 'Правильный ответ:',
    quizDescriptionTranslation: 'Перевод описания:',
    quizDescriptionOriginal: 'Исходное описание:',
    ...
    collectionPracticeStart: 'Практиковаться',
    collectionPracticeTitle: 'Практика коллекции',
    collectionPracticeHistory: 'Практика коллекции',
    collectionPracticeUnavailable: 'Добавьте хотя бы одно слово из этой коллекции в словарь для практики.',
    collectionPracticeEmpty: 'В словаре сейчас нет доступных слов из этой коллекции.',
    collectionPracticeLoadError: 'Не удалось начать практику коллекции. Попробуйте ещё раз.',
    collectionPracticeKnowledgeUnchanged: 'Уровень знания не изменился',
    collectionPracticePointsUnchanged: '±0',
    collectionPracticePointsUnchangedHint: 'Практика коллекции не изменяет уровень знания.',
    collectionPracticeMatching: 'Повторение пар',
    collectionPracticeAgain: 'Практиковаться ещё',
    collectionPracticeStop: 'Закончить практику',
    ...
    collectionOpenAddTranslationAgain: 'Открыть это окно снова',
    ...
    collectionShareUnavailable: 'Опубликуйте коллекцию, прежде чем делиться ею.',
    ...
    collectionLinkCopiedErrorDescription: 'Не удалось скопировать ссылку. Попробуйте ещё раз.',
    ...
    collectionPreviewPublished: 'Опубликованная коллекция',
    collectionPreviewShared: 'Общая коллекция',
    collectionPreviewLoading: 'Загрузка коллекции...',
    collectionPreviewUnavailableTitle: 'Коллекция недоступна',
    collectionPreviewUnavailableDescription:
        'Эта коллекция не существует, больше не опубликована или ссылка указана неверно.',
    collectionPreviewBack: 'Вернуться в Termorize',
    collectionPreviewJoinTitle: 'Добавьте коллекцию себе',
    collectionPreviewJoinDescription:
        'Войдите, чтобы добавить коллекцию в свой список, а затем сохранить любые слова в словарь.',
    collectionPreviewUseTitle: 'Используйте эти слова в Termorize',
    collectionPreviewUseDescription:
        'Войдите, чтобы сохранить часть или все пары слов и начать практиковаться в Termorize.',
    collectionPreviewTryGuest: 'Попробовать без регистрации',
    collectionPreviewGuestError: 'Не удалось создать временный аккаунт. Попробуйте ещё раз.',
    collectionPreviewWordsTitle: 'Слова в этой коллекции',
    collectionPreviewWordsDescription: 'Предпросмотр всех опубликованных пар слов без редактирования.',
    collectionPreviewFooter: 'Переводите. Собирайте. Запоминайте.',
    collectionPreviewMetaDescription: '{count} пар слов в «{title}». Посмотрите опубликованную коллекцию Termorize.',
