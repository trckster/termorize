...
type BotTexts struct {
	...
	ExerciseDescriptionTranslation         string
	ExerciseDescriptionOriginal            string
	...
	ButtonIdiomTranslate                  string
	ButtonIdiomDismiss                    string
...
var botTextsEn = BotTexts{
	...
	ExerciseDescriptionTranslation:         "Description translation:",
	ExerciseDescriptionOriginal:            "Original description:",
	...
	ButtonIdiomTranslate:                  "Translate",
	ButtonIdiomDismiss:                    "Dismiss",
	...
	LanguageNames: map[enums.Language]string{
		...
		enums.LanguageIt: "Italian",
		enums.LanguageDe: "German",
		enums.LanguageEs: "Spanish",
...
var botTextsRu = BotTexts{
	...
	ExerciseDescriptionTranslation:         "Перевод описания:",
	ExerciseDescriptionOriginal:            "Исходное описание:",
	...
	ButtonIdiomTranslate:                  "Перевести",
	ButtonIdiomDismiss:                    "Скрыть кнопки",
	...
	LanguageNames: map[enums.Language]string{
		...
		enums.LanguageIt: "Итальянский",
		enums.LanguageDe: "Немецкий",
		enums.LanguageEs: "Испанский",
...
func localizedLanguageName(language enums.Language, texts BotTexts) string {
	if name := texts.LanguageNames[language]; name != "" {
		return name
	}
