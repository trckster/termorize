...
func defineProtectedRoutes(group *gin.RouterGroup) {
	...
	group.POST("/daily-idiom/:id/translate", controllers.TranslateDailyIdiom)
	...
	group.GET("/admin/description-models", controllers.GetAdminDescriptionModels)
	group.GET("/admin/word-descriptions", controllers.GetAdminWordDescriptions)
	group.POST("/admin/word-descriptions/:id/preview", controllers.PreviewAdminWordDescription)
	group.POST("/admin/word-descriptions/:id/approve", controllers.ApproveAdminWordDescription)
