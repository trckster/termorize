...
- **Smart exercises** — Multiple exercise types: direct & reversed translation, multiple choice, and web quiz mode. Levenshtein-aware grading rewards "almost correct" answers. More types of exercises are coming!
